...
<div class="card-list two-cards" style="max-height: 3060px">
	<s:iterator value="apkInfos">
		<div class="card no-rationale square-cover apps tiny"
					...
					<div class="cover-image-container">
						<div class="cover-outer-align">
							<div class="cover-inner-align">
								<img alt="${title}" class="cover-image"
									src="${ldResIconPath}" aria-hidden="true">
							</div>
						</div>
					</div>
					<a class="card-click-target"
						href="${ctx}/detail.shtml?id=${packageName}" aria-hidden="true"
						tabindex="-1"> 
						<span class="movies preordered-overlay-container id-preordered-overlay-container"
							style="display:none"> 
