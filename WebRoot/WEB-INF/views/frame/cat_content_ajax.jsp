...
<h1 class="cluster-heading" style="width: 75.6%;">
	<a class="title-link id-track-click" href=" "> 应用</a> <a
		class="see-more play-button small id-track-click apps id-responsive-see-more"
		href=" ">查看更多</a>
</h1>
<div class='card-list two-cards' style='max-height: 3060px'>
	<s:iterator value="apkInfos" id="apkInfos">
		<div class='card no-rationale square-cover apps tiny' data-docid="${packageName}">
			<div class='card-content id-track-click id-track-impression'>
				<a class='card-click-target' href='${ctx}/' aria-hidden='true' tabindex='-1'></a>
				<div class='cover'>
					<div class='cover-image-container'>
						<div class='cover-outer-align'>
							<div class='cover-inner-align'>
								<img alt="${title}" class='cover-image'  src="${ldResIconPath}" aria-hidden='true'>
							</div>
						</div>
					</div>
					<a class='card-click-target' href="${ctx}/detail.shtml?id=${packageName}" aria-hidden='true' tabindex='-1'>
				...
				<div class='details'>
					<a class='card-click-target' href='#' aria-hidden='true' tabindex='-1' onclick='detail()'></a>
					<h2>
					...
					<span class='stars-container'>
						<a href='#' tabindex='-1'>
							<div class='reason-set-star-rating'>
								<div class='tiny-star star-rating-non-editable-container'aria-label='评了颗星（最高5颗星'>
