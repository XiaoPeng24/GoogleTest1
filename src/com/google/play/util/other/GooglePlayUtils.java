...
public class GooglePlayUtils {
	/**
	 * 使用"Galaxy S3"属性生成验证请求<br/>
	 * Generates android checkin request with properties of "Galaxy S3".<br/>
	 * 
	 * <a href="http://www.glbenchmark.com/phonedetails.jsp?benchmark=glpro25
	 * &D=Samsung+GT-I9300+Galaxy+S+III&testgroup=system"</a>
	 */
		...
		return AndroidCheckinRequest
				...
				.setCheckin(
						AndroidCheckinProto
								...
								.setUserNumber(0)).setLocale("en_US")
				.setTimeZone("Europe/Istanbul").setVersion(3)
				.setDeviceConfiguration(getDeviceConfigurationProto())
				.setFragment(0).build();
	}
	
	/**
	 * 把响应的字符串转化成key-value的形式放到Map容器中<br/>
	...
	public static byte[] readAll(InputStream inputStream) throws IOException {
		...
		for (int k = 0; (k = inputStream.read(buffer)) != -1;) {
	 ...
	 * @return
	 */
	private static DeviceConfigurationProto getDeviceConfigurationProto() {
