package com.google.play.net.http.recommend.impl;
...
public class RecommendHttpImpl extends BaseHttpImpl implements RecommendHttp {
	...
	public List<ApkInfo> getRecomendApks(String packageName,
		...
		try {
			HttpEntity entity = executeGet(Constants.RECOMMEND_LIST,
					new String[][] {
					{ "c", "3" },
					{ "doc", packageName },
					{
